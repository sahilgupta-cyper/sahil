...
interface DashboardViewProps {
  ...
  // FIX: Changed `clients` prop type from `number` to `Client[]` to allow looking up client names.
  clients: Client[];
  enquiries: number;
}
...
// FIX: Destructured `clients` from props to make it available within the component.
